 ...
 * @property {boolean|null} [wvoTraject] - WVO-traject tri-state flag, BJ1 only; null/undefined = "nog niet ingevuld" (M42 T3)
 * @property {'sbl'|'sbc'|null} [roosendaalTraject] - Roosendaal-only traject keuze, BJ2 only; null/undefined = "nog niet gekozen" (M42 T3b)
 */
