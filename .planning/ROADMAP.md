...
**Success Criteria** (what must be TRUE):
  1. Mentor kan een of meerdere PDFs tegelijk importeren via drag-and-drop of bestandskiezer
...
**Success Criteria** (what must be TRUE):
  ...
  5. Risicosignaal "Negatief" wordt correct berekend: >6 onvoldoende OF >2 onvoldoende binnen een leerlijn
...
**Success Criteria** (what must be TRUE):
  ...
  5. Na sluiten en heropenen van de browser zijn alle geimporteerde data en instellingen nog aanwezig
